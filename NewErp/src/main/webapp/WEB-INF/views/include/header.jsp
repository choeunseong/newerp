      ...
      <ul class="navbar-nav mr-auto">
         ...
         <li class="dropdown mega-dropdown mg-t-5">
            <a class="dropdown-toggle btn mg-r-10" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">본/지사
            </a>
      ...
      <ul class="list-inline justify-content-end">
         ...
         <li class="list-inline-item dropdown">
            <a  href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	            <span class="select-profile">${ sessionScope.user.user_nm }님 환영합니다!</span> 
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-profile shadow-2">
               <div class="user-profile-area">
                  ...
                  <a href="" class="dropdown-item"><i class="icon-user" aria-hidden="true"></i> 내 정보 보기</a>
                  ...
                  <a href="javascript:;" class="dropdown-item" onclick="fnLogOut()"><i class="icon-power" aria-hidden="true"></i> log-out</a>
               </div>
            </div>
         </li>
