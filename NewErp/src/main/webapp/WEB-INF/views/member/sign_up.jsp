...
<div class="card shadow-none pd-20 mx-auto wd-900 bd-1 align-self-center">
	...
	<p class="text-center">가입정보를 입력해주세요.</p>
	<div class="card mg-b-20">
		<div class="card-header">
		<h4 class="card-header-title">
			회원가입(<span class="tx-danger"> *</span> 표시는 필수 입력사항 입니다.)
		</h4>
		...
		<div class="card-body collapse show" id="collapse7">
			<form id="memberSignUpForm" name="memberSignUpForm" method="post" enctype="multipart/form-data">
				<input type="hidden" id="check_conFirm" name="check_conFirm" value="N">
				<input type="hidden" id="emplSearchKey" name="emplSearchKey" value="">
				...
				<div class="form-row">
					...
					<div class="col-md-6 mb-3">
						...
						<div class="input-group">
							...
							<input type="hidden" id="ori_user_empl" name="user_empl" value="">
							<div class="input-group-prepend">
								<a href="javascript:;" class="input-group-text" onclick="fnEmplSearchOpen('member')" title="담당자 검색">
									<span>
				...
				<div class="form-row">
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control" id="user_nm" name="user_nm" placeholder="이름을 입력해주세요" value="" >
					</div>
					<div class="col-md-6 mb-3">
						<label for="user_age">생년월일</label>
						<input type="text" class="form-control" id="user_age" name="user_age" placeholder="생년월일을 입력해주세요  ex)901203" value="" >
					</div>
				</div>
				<div class="form-row">
					<div class="col-md-6 mb-3">
						<label for="user_phone">전화번호</label><span class="tx-danger"> *</span>
						<input type="text" class="form-control" id="user_phone" name="user_phone" placeholder="전화번호를 입력해주세요" value="" >
					</div>
					<div class="col-md-6 mb-3">
						<label for="user_email">이메일</label><span class="tx-danger"> *</span>
						<input type="text" class="form-control" id="user_email" name="user_email" placeholder="이메일주소를 입력해주세요" value="" >
					</div>
				</div>
				<div class="form-row">
					<div class="col-md-12 mb-3">
						...
						<div class="input-group">
							<input type="file" class="form-control" id="file_user_file" name="file_user_file" placeholder="커리큘럼 외 기타자료" value="" >
							<div class="input-group-prepend">
					...
					<div class="col-md-12 mb-3">
						...
						<div class="input-group">
							<input type="file" class="form-control" id="file_user_pict" name="file_user_pict" placeholder="사진을 등록해주세요" aria-describedby="inputGroupPrepend" >
							<div class="input-group-prepend">
								<span class="input-group-text">@</span>
							</div>
						</div>
				...
				<div class="col-md-12 text-center">
					<a href="javascript:;" onclick="fnSignUp('sign')" class="btn btn-success">가입하기</a>
